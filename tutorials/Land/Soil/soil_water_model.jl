...
"""
Base.@kwdef struct SoilModelMoisture{AbstractParameterSet, Fκ, Fiν, Fsν, Fih} <: BalanceLaw #FiS_l, Fiψ_m, Fiψ, Fih
    "Parameters"
...
function  soil_nodal_update_aux!(
  ...
  t::Real)
    ...
    aux.κ = hydraulic_conductivity2(K_sat, ψ, n, α)
    #aux.κ = hydraulic_conductivity(K_sat,S_l,ψ, aux.z, "Havercamp")
