...
let
    ...
    expected_result[1] = 1.2437314516997455e-01
    expected_result[2] = 9.8829388561567838e-02
    expected_result[3] = 7.2096312912198937e-02
    expected_result[4] = 4.7720226730379636e-02
    ...
    @testset "$(@__FILE__)" begin
        ...
        for l in 1:numlevels
            ...
            brickrange = (
                ...
                range(FT(0); length = polynomialorder[1] * Ne + 1, stop = 1),
            )
            ...
            final time       = %.16e
            time step        = %.16e
            """ FT 2 Ne polynomialorder[1] timeend dt
            ...
            @test result[l] ≈ FT(expected_result[l])
            if l > 1
